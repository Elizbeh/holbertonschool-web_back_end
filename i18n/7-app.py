...
def welcome():
    """
    Render a welcome message based on the user's login status.
    """
...
def get_timezone() -> str:
    ...
    Prioritizes URL parameters, user settings, and defaults to app config.
    Returns the selected time zone.
    """
    try:
        url_timezone = request.args.get('timezone')
        if url_timezone and pytz.timezone(url_timezone):
            return url_timezone
